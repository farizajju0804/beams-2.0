 ...
 */
const Challenge: React.FC<TopicOfTheDayProps> = ({ topic, username }) => {
  ...
  return (
    <div className="w-full py-1 mb-4 text-left relative max-w-6xl mx-auto">
      ...
      <div className="pl-6 lg:pl-0 flex flex-col items-start lg:items-center">
        <h1 className="text-lg md:text-2xl text-text font-poppins font-semibold mb-[1px]">Challenge of the Day</h1>
