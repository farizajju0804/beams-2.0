...
const PlayerComponent: React.FC = () => {
  ...
  return (
    <div className='w-full flex flex-col gap-2 lg:px-[40px]'>
      ...
      <div className={`w-full lg:w-full relative bg-[#000000] flex min-h-[300px] items-start ${isOpen ? 'lg:min-h-[380px]' : 'lg:min-h-[460px]'} justify-center`}>
        <div className='px-4 py-8 lg:py-4 mb-10 w-full'>
        ...
        <Image className='absolute w-full h-[40px] bottom-0 right-0 left-0' width={0} height={0} sizes='100%' src='/images/beams-theatre/theatre-seat.png' alt='row' />
      </div>
      <EpisodeDetails/>
    </div>
  )
