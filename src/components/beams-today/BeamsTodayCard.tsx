...
const BeamsTodayCard: React.FC<BeamsTodayCardProps> = ({ topic, className = '' }) => {
  ...
  return (
    <div
      className={`h-[400px] cursor-pointer aspect-[9/16] rounded-3xl flex flex-col justify-between px-4 py-6 box-border leading-[normal] tracking-[normal] ${className}`}
      style={{ 
    ...
    >
      ...
      <section className="self-stretch mt-auto [backdrop-filter:blur(20px)] rounded-3xl [background:linear-gradient(92.11deg,_#fff5ed,_rgba(255,_255,_255,_0.2)_99.93%)] flex flex-col items-start justify-start p-4 gap-2 text-left text-base md:text-xl text-black">
